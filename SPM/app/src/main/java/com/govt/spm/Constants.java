...
public class Constants {
    ...
    public static final String FILE_ROOT_URL="http://ec2-3-7-135-193.ap-south-1.compute.amazonaws.com/SPA_Webservices/";
    ...
    public static final String GET_STUDENT_PROFILE = ROOT_URL+"getStudentProfile.php";
